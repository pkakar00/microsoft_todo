...
export default function Important() {
  ...
  const newState = useMemo(() => {
    ...
    let x = state.tasksArray;
    let newState = [];
    x.forEach((element) => {
      if (element.important) newState.push(element);
    });
    return {...state, tasksArray:newState};
  }, [state]);
    ...
    <div className="main">
      <div>
        ...
        <main className="mainContent">
          <ul>
            <Li dispatch={dispatch} state={newState} />
          </ul>
        </main>
      </div>
          ...
          <form
            onSubmit={(e) => {
              ...
              dispatch({
                ...
                info: new Task(input, taskList.current.innerText, false, true),
              });
            }}
          >
            <input
